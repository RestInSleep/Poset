...
// first - smaller elements, second - bigger elements
...
static std::unordered_map<unsigned long, poset_t> poset_set;
...
bool poset_add(unsigned long id, char const *value1, char const *value2) {
   ...
   //check if elements are in a relation
    if(compareStrings(str1, str2, poset_set[id]) || compareStrings(str2, str1, poset_set[id])) {
        return false;
    }
